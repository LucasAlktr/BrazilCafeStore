    ...
    <div>
      ...
      <section className='menu-text'>
        ...
        <div className="cards">
          ...
          <div className="card">
            <picture><img src="./assets/coffee_cup.jpg" alt="Coffee with Milk" /></picture>
          ...
          <div className="card">
            <picture><img src="./assets/coffee_cup.jpg" alt="Cappuccino Brasileiro" /></picture>
          ...
          <div className="card">
            <picture><img src="./assets/coffee_cup.jpg" alt="Drip Coffee" /></picture>
          ...
          <div className="card">
            <picture><img src="./assets/coffee_cup.jpg" alt="Brazilian Black Coffee" /></picture>
          ...
          <div className="card">
            <picture><img src="./assets/coffee_cup.jpg" alt="Cold Brew" /></picture>
            <h3>Cold Brew</h3>
            <strong>$5.20</strong>
